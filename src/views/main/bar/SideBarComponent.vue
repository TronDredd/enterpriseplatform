<template>
    <div id="side-bar" class="text-center">
        <div class="logo-box">
            <img src="../../../assets/company_logo.png" class="logo-img">
            <span>企业购销</span>
            <img src="../../../assets/fold@a622f7fa.png" class="fold-img">
        </div>
        <ul class="menu-root" id="accordion">
            ...
            <li class="menu-item">
                ...
                <ul class="collapse sublist show" id="nav-product" aria-labelledby="nav-product-tab">
                    <li>
                        <router-link :to="{path: '/main/product_list', query:{page_num: 1, page_size: 20, filter: 0}}"><span>供应列表</span></router-link>
                    </li>
                    <li>
                        <router-link :to="{path: '/main/my_product', query: {user_id: getUserId}}"><span>我的供应</span></router-link>
                    </li>
                </ul>
            </li>
        </ul>
